inherited fmReservaEditor: TfmReservaEditor
  ...
  object IB_CheckBox1: TIB_CheckBox [10]
    Left = 483
    Top = 156
    Width = 73
    Height = 17
  ...
  object IB_Date2: TIB_Date [15]
    Left = 444
    Top = 72
    Width = 93
    Height = 21
    AutoLabel.Caption = 'Devolu'#231#227'o:'
    AutoLabel.Kind = albLeft
  ...
  inherited IB_Query1: TIB_Query
    ...
    EditSQL.Strings = (
      ...
      '   RESERVA.DATA_DEVOLUCAO = :DATA_DEVOLUCAO'
      'WHERE'
      '   CODIGO = :OLD_CODIGO')
    InsertSQL.Strings = (
      'INSERT INTO RESERVA('
